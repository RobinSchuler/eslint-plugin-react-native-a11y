  ...
  create: function create(context) {
    return {
      JSXOpeningElement: function JSXOpeningElement(node) {
        if ((0, _isTouchable.default)(node, context) && !(0, _jsxAstUtils.hasProp)(node.attributes, 'accessibilityRole') && !(0, _jsxAstUtils.hasEveryProp)(node.attributes, deprecatedProps) && (0, _jsxAstUtils.getLiteralPropValue)((0, _jsxAstUtils.getProp)(node.attributes, 'accessible')) !== false) {
          context.report({
            node,
